...
public class ScoredTOP_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("featExt.src.InfoAnnotation.ScoredTOP");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "featExt.src.InfoAnnotation.ScoredTOP");
