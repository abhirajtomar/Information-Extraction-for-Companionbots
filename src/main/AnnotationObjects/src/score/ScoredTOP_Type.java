...
/* First created by JCasGen Mon Jun 17 16:20:45 CDT 2013 */
package main.featExt.src.score;
...
public class ScoredTOP_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("main.featExt.src.score.ScoredTOP");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "main.featExt.src.score.ScoredTOP");
